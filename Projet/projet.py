...
# Menu streamlit
st.sidebar.header('Information étudiant :')
st.sidebar.text("Prenom : Wilhem")
st.sidebar.text("Nom : Harat")
st.sidebar.text("Promo : 2025")
st.sidebar.text("Classe : BIA1")
st.sidebar.markdown(
    "Lien de mon LinkedIn : [Cliquez ici](https://www.linkedin.com/in/wilhem-harat/)")
...
st.text("Légendes :")
st.text("- Catégorie d'infrastructures :")
for label, description in infra_labels.items():
    st.text(f"  - {label}: {description}")

st.text("- Régime de circulation :")
st.text("  1 – A sens unique ")
st.text("  2 – Bidirectionnelle ")
st.text("  3 – A chaussées séparées")
st.text("  4 – Avec voies d’affectation variable ")
...
st.text("- Situation de l’accident :")
st.text("  0 – Aucun ")
st.text("  1 – Sur chaussée ")
st.text("  2 – Sur bande d’arrêt d’urgence ")
st.text("  3 – Sur accotement ")
st.text("  4 – Sur trottoir ")
st.text("  5 – Sur piste cyclable ")
st.text("  6 – Sur autre voie spéciale ")
st.text("  8 – Autres ")

st.text("- Etat de la surface :")
st.text("  1 – Normale ")
st.text("  2 – Mouillée ")
st.text("  3 – Flaques ")
st.text("  4 – Inondée ")
